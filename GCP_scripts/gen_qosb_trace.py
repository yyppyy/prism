...
def process_directory(directory):
    ...
    from_directory = directory.replace('qosb', from_lock_type)
    ...
    for root, dirs, files in os.walk(from_directory):
        for file in files:
            if file.endswith('.gz'):
                ...
                gz_file_path = from_gz_file_path.replace(from_lock_type, 'qosb')
                ...
                out_file_path = from_out_file_path.replace(from_lock_type, 'qosb')
